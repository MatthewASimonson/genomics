...
# OUTPUTS: a data frame containing rows of subjects and columns for each megabase across all autosomal regions of the genome (2877 total); if a subject containts a run within a given bin (contained in each column), their respective row will contain a '1', else a '0' for that megabase bin. The first 4 columns contain annotation information.
...
base.positions.per.bin <- 1000000 # set base positions per bin here
